    ...
    <header className="relative p-16 text-center">
        <Link href="/">
            ...
            <h2>Beinging your stories</h2>
                ...
                <p className="text-white relative">To life!</p>
                </div>
            </div>
        </Link>
        ...
        <div className="absolute -top-5 right-5 flex space-x-2 ">
            <Link href="/">
                <FilePen 
                    className="w-8 h-8 lg:w-10 lg:h-10 mx-auto text-purple-500 mt-10 border border-purple-500 p-2 rounded-md hover:opacity-70 cursor-pointer transition-all duration-250"
                />
            </Link>
